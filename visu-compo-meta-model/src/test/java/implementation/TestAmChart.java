...
public class TestAmChart {
    ...
    public void testConvertIntPairToAmChartDataFormat()  {
        ...
        data.put(1.0,99.0);
        data.put(2.0,98.0);
        assertEquals("[{\"t\":1,\"v\":99},{\"t\":2,\"v\":98}]",new AmChartFormater().convertData2LibraryFormat(data));
    }
    ...
    public void testConvertDoublePairToAmChartDataFormat()  {
        ...
        data.put(1.1,99.1);
        data.put(2.1,98.1);
        assertEquals("[{\"t\":1.1,\"v\":99.1},{\"t\":2.1,\"v\":98.1}]",new AmChartFormater().convertData2LibraryFormat(data));
    }
